...
public class DAO {
    ...
    private static String excluir_cartas_jogador = "delete from baralho_jogador;";
    ...
    private static String excluir_cartas_adversario = "delete from baralho_adversario;";
